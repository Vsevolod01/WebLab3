...
public class DBManager implements Serializable {
    ...
    public boolean addPoint(Dot dot) {
        ...
        try {
            Connection connection = DriverManager.getConnection("jdbc:postgresql://pg:5432/studs", "s285641", "pln913");
            PreparedStatement preparedStatement
                    = connection.prepareStatement("INSERT INTO s285641.lab3 (x, y, r, \"currentTime\", HIT) VALUES (?, ?, ?, ?, ?);");
    ...
    public ArrayList<Dot> getPoints() {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:postgresql://pg:5432/studs", "s285641", "pln913");
